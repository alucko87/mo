...
<head>
	...
	<link href="/css/flora.datepick.css" rel="stylesheet" type="text/css">
</head>
<body class="back">
	<div class="top_menu">
	...
	<div class="main_block">
		...
		<table border="0" cellpadding="1" cellspacing="1" width="100%">
			<tr>
				<td width="230px"><div class="main_bottom_2"><a href="/quote/in">Предложить лекарство</a></div></td>
				<td><div class="select_alfabet"><span id="alfabet_edit">Все предложения по алфавиту</span></div></td>
				<td align="right"><div class="main_bottom_1"><a href="/quote/out">Получить лекарство</a></div></td>
			</tr>
		</table>

    <?php include 'application/views_quote/'.$content_view; ?>
	</div>
...
<div><img src="/images/facebook.png"><br>Facebook</div><div><img src="/images/linkedin.png"><br>Linkedin</div><div><img src="/images/odnoklassniki.png"><br>Odnoklassniki</div><div><img src="/images/twitter.png"><br>Twitter</div><div><img src="/images/vkontakte.png"><br>Vkontakte</div><div><img src="/images/yahoo-bookmarks.png"><br>Bookmarks</div>	
</div>	
